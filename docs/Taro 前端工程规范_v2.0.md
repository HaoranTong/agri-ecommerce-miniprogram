...
> 每次新增页面需同步改动：`app.config.ts` → `docs/MINIPROGRAM_SPEC(v2.0).md` → `docs/API_CONTRACT_V2.3.md`。
...
- `src/utils/error-map.ts` 维护 `error_code -> message` 映射，尊重 `docs/DATA_DICTIONARY.md`。
...
- 错误码、类型定义须与 `docs/DATA_DICTIONARY.md`、`docs/API_CONTRACT_V2.3.md` 保持一致。