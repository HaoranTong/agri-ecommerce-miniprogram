...
> **生成时间**：2025-01-22  
> **对照文档**：API_CONTRACT_V2.3.md、CODE_API_GAP_LIST.md、DATA_MODEL_v2.1.md  
...
**API契约要求**（API_CONTRACT_V2.3.md 第435行）：
```json
{
  "variation_id": 205,
  "quantity": 2,
...
**API契约要求**（API_CONTRACT_V2.3.md 第476行）：
```json
{
  "order_id": 1001,
...
**API契约要求**（API_CONTRACT_V2.3.md 第577行）：
```json
{
  "order_id": 1001,
...
- ⚠️ 但API契约内为 `name`（见 API_CONTRACT_V2.3.md 第499行）
...
**API契约说明**（API_CONTRACT_V2.3.md 第783行）：
...
**API契约说明**（API_CONTRACT_V2.3.md 第638行）：
...
**API契约支持**（API_CONTRACT_V2.3.md 第815行）：
```
...
**问题描述**：
- ❌ 文档要求统一错误码映射（MINIPROGRAM_SPEC_v2.0.md 第476行）
